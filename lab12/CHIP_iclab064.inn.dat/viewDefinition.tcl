...
create_library_set -name lib_min\
   -timing\
    ...
    ${::IMEX::libVar}/mmmc/MEM32x32_BC.lib\
    ${::IMEX::libVar}/mmmc/MEM36x36_BC.lib\
    ${::IMEX::libVar}/mmmc/MEM5x5_BC.lib]\
   -si\
...
create_library_set -name lib_max\
   -timing\
    ...
    ${::IMEX::libVar}/mmmc/MEM32x32_WC.lib\
    ${::IMEX::libVar}/mmmc/MEM36x36_WC.lib\
    ${::IMEX::libVar}/mmmc/MEM5x5_WC.lib]\
   -si\
